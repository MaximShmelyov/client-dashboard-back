...
export const ENV = {
  ...
  BITRIX_ITEMS_PER_PAGE: process.env.BITRIX_ITEMS_PER_PAGE
    ...
    : 50,
  BITRIX_CALLBACK_RECORD_TITLE: process.env.BITRIX_CALLBACK_RECORD_TITLE!,
  BITRIX_CALCULATION_REQUEST_RECORD_TITLE:
    process.env.BITRIX_CALCULATION_REQUEST_RECORD_TITLE!,
  ...
  CALCULATION_REQUEST_PHOTO_MAX_FILESIZE_IN_MB: process.env
    .CALCULATION_REQUEST_PHOTO_MAX_FILESIZE_IN_MB
